...
\begin{document}
	...
	\begin{itemize}
		...
		{\footnotesize \textit{\underline{Author} \hfill Open-source, Kotlin, Firebase, Java, Gradle}} \\[0.2em]
		...
		{\footnotesize \textit{\underline{Author} \hfill Open-source, Java, Python, Gradle}} \\[0.2em]
		...
		{\footnotesize \textit{\underline{Software Engineer} \& \underline{Designer} at Corgi for Feedly Lock Screen \hfill Java}} \\[0.2em]
		...
		{\footnotesize \textit{\underline{Author} \hfill Open-source, Java, OpenGL ES2}} \\[0.2em]
		...
		{\footnotesize \textit{\underline{Author} \hfill Open-source, Python 3}} \\[0.2em]
		...
		{\footnotesize \textit{\underline{Software Engineer} \& \underline{Designer} \hfill Open-source, Java}} \\[0.2em] 
