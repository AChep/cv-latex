...
\begin{document}
	...
	\begin{itemize}
		...
		Development from scratch. Maintained and leaded the android project. Key features: custom navigation handling, using ExoPlayer's cache to cache all content, custom views, screens & nav graph are defined by the .json, Unity games, Web games, exstensive use of reactive patterns and more. 
