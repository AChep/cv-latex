...
\begin{document}
	...
	\begin{multicols}{2}
	\begin{itemize}
		\item \textbf{Programming} with Kotlin, Java, Dart, JavaScript, Python etc.
	...
	\begin{itemize}
		\item \faAndroid \enskip Multi-client app for playing videos \& games. \\[0.2em]
		...
		{\footnotesize Android Developer, used \{Kotlin, Coroutines, MVVM, Dagger, clean, data binding \& more \} \hfill [2020--Present]} \\[0.2em]
