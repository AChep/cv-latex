...
\begin{document}
	...
	\begin{itemize}
		...
		\item \faAndroid \enskip \faLinux \enskip \textbf{Keyguard} --- Multifplatform password manager. \\[0.2em]
		{\footnotesize \{Koltin, Compose, Encryption\} \hfill [2021--Present]} \\[0.2em]
		Key features: encrypted state, fluent animations, multiplatform support, multiaccount support. 
