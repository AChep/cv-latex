...
\rfoot{\small \the\year\hspace{6pt}\myfullname}
...
\begin{document}
	...
	\begin{multicols}{2}
	\begin{itemize}
		\item \textbf{Programming} with Kotlin, Python, Java, TypeScript, JS, Dart etc.
		\item \textbf{Native Android apps} with Kotlin, Java, \textbf{multiplatform apps} with Kotlin \& Compose, Kotlin Native \textbf{crossplatform apps} with Dart \& Flutter, TypeScript \textbf{web apps} with TypeScript \& NextJS and more.
		\item \textbf{Building} with Gradle, Webpack, Maven, \textbf{CI/CD} with GitHub Actions, GitLab, CircleCI, Fastlane etc.
		\item \textbf{Designing apps} with OOP and FP principles, Hexagonal and Clean architecture, MVVM, MVI, MVP patterns and more.
		\item \textbf{Databases} with SQL, NoSQL.
		\item \textbf{Backend} with Kotlin \& ktor, NodeJS.
